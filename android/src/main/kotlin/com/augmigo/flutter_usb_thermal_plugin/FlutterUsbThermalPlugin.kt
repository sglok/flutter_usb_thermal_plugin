package com.augmigo.flutter_usb_thermal_plugin

import android.app.Activity
import android.content.Context
import android.os.Build
import androidx.annotation.NonNull
import com.augmigo.flutter_usb_thermal_plugin.adapter.USBPrinterAdapter
...
class FlutterUsbThermalPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_usb_thermal_plugin")
